			...
			<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<form method="POST" enctype="multipart/form-data"/ class="form w-100">
							...
							<button type="submit" name="btningresar" class="btn btn-lg btn-primary w-100 mb-5" value="ingresar" >Ingresar</button>
								...
								<a href="https://accounts.google.com/o/oauth2/auth?client_id=638975191598-dbkahvb86h4pnovdcnjln9i8r34hlcrn.apps.googleusercontent.com&redirect_uri=https://dev.pkroz.net/login/google.php&response_type=code&scope=openid%20email%20profile" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
