                ...
                <form class="form w-100" method="POST" enctype="multipart/form-data">
                    <div class="mb-5 text-center">
                        ...
                        <div class="text-gray-400 fw-bold fs-4">Ya tienes una cuenta?
                            <a href="login/index.php" class="link-primary fw-bolder">Iniciar sesión</a>
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-4">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px" id="imagen"
                    ...
                    <div class="text-center">
                        <button type="submit" name="btnregistrar" class="btn btn-lg btn-primary"
                            value="registrar">Registrarse</button>
                    </div>
                </form>
            </div>
        </div>
