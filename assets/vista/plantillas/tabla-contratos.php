...
<table class="table align-middle table-row-dashed fs-6 gy-5 " id="kt_table_users">
    ...
    <tbody class="text-gray-600 fw-bold">
        ...
        <tr>
            ...
            if ($dataUsuario1['fechaFin'] != "" and $dataUsuario1['fechaInicio'] != "" && strtotime($dataUsuario1['fechaFin']) < strtotime($fechaActual)) { ?>
                <td>
                    <a href="../ejemplo.php?nombre=<?php echo $dataUsuario1['nombres']; ?>&apellido=<?php echo $dataUsuario1['apellidos']; ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
