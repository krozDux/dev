                            ...
                            <div class="d-flex flex-stack mb-1">
                                ...
                                <div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                        ...
                                        <div class="menu-item px-3">
                                        <button class="menu-link px-3 modal-trabajo1" data-idproyecto="<?php echo $dataUsuario15['idTarea']; ?>" style="border: none; background: none; text-decoration: none; color: inherit; display: inline-block;"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_new_user1">Agregar documento</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="fs-4 fw-bolder mt-1 mb-1 text-gray-900 text-hover-primary">
                                <?php echo $dataUsuario15['nombre']; ?></div>
                ...
                <div class="col-md-4 col-lg-12 col-xl-4">
                    ...
                    <div class="card mb-6 mb-xl-9">
                        <div class="card-body">
                            <div class="d-flex flex-stack mb-1">
                                ...
                                <div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                        ...
                                        <div class="menu-item px-3">
                                            <button class="menu-link px-3 modal-trabajo1" data-idproyecto="<?php echo $dataUsuario16['idTarea']; ?>" style="border: none; background: none; text-decoration: none; color: inherit; display: inline-block;"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_new_user1">Agregar documento</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="fs-4 fw-bolder mt-1 mb-1 text-gray-900 text-hover-primary">
                                <?php echo $dataUsuario16['nombre']; ?></div>
                            <div class="d-flex flex-stack flex-wrapr">
                                <div class="d-flex my-1">
                                    <div class="border border-dashed border-gray-300 rounded py-2 px-3">
                                        <span class="svg-icon svg-icon-3">
                ...
                <div class="col-md-4 col-lg-12 col-xl-4">
                    ...
                    <div class="card mb-6 mb-xl-9">
                        <div class="card-body">
                            <div class="d-flex flex-stack mb-1">
                                ...
                                <div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                        ...
                                        <div class="menu-item px-3">
                                        <button class="menu-link px-3 modal-trabajo1" data-idproyecto="<?php echo $dataUsuario17['idTarea']; ?>" style="border: none; background: none; text-decoration: none; color: inherit; display: inline-block;"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_new_user1">Agregar documento</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="fs-4 fw-bolder mt-1 mb-1 text-gray-900 text-hover-primary">
                                <?php echo $dataUsuario17['nombre']; ?></div>
                            <div class="d-flex flex-stack flex-wrapr">
                                <div class="d-flex my-1">
                                    <div class="border border-dashed border-gray-300 rounded py-2 px-3">
                                        <span class="svg-icon svg-icon-3">
