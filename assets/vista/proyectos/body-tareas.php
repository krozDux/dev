        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="d-flex flex-column-fluid">
                ...
                <div class="d-flex flex-column flex-column-fluid container-fluid">
                    ...
                    <?php include_once 'tabla-tareas.php'?>
...
<div class="modal fade" id="kt_modal_new_user1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            <div class="modal-header pb-0 border-0 justify-content-end">
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form class="form" method="POST" enctype="multipart/form-data">
                    <div class="mb-3 text-center">
                        ...
                        <input type="text" id="idProyectoInput" name="idProyecto" hidden>
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Descripción de la tarea</span>
