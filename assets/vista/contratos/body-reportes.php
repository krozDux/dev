	                                ...
	                                <div class="card h-xl-100 pb-5">
	                                    <div class="card-header border-0 pt-5">
	                                        <h3 class="card-title align-items-start flex-column">
	                                            ...
	                                            <span class="text-muted mt-1 fw-bold fs-7">Cantidad de inicialización de contratos iniciados por mes</span>
	                                        </h3>
	                                    </div>
                                ...
                                <div class="col-xl-6 mb-5 mb-xl-10">
	                                <div class="card h-xl-100 pb-5">
	                                    <div class="card-header border-0 pt-5">
	                                        <h3 class="card-title align-items-start flex-column">
	                                            <span class="card-label fw-bolder fs-3 mb-1">Inicialización de contratos</span>
	                                            <span class="text-muted mt-1 fw-bold fs-7">Cantidad de inicialización de contratos iniciados por mes y rol</span>
	                                        </h3>
	                                    </div>
	                                    <div class="card h-md-100 px-5">
	                                        <div class="table-responsive">
