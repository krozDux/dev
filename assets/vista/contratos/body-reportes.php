                                ...
                                <div class="card h-md-100 px-5">
                                    <div class="table-responsive">
                                        ...
                                        <?php  while ($dataChart4 = mysqli_fetch_array($querychart4)) { ?>
                                            <span class="text-muted mb-2 mt-1 fw-bold fs-7" id="chart-title"><?php echo $dataChart4['nombre_mes']; ?> [<?php echo $dataChart4['total_registros_rol1']; ?> clientes] [<?php echo $dataChart4['total_registros_rol2']; ?> proveedores] |</span>
                                            <?php } ?>
                                    </div>
                                </div>
                            </div>
