...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed">
    ...
    <?php
        include('../config.php');
        $sqlpro1 = ("SELECT * FROM usuarios INNER JOIN contratos ON usuarios.id = contratos.idUsuario WHERE contratos.fechaFin < CURDATE();");
        $querypro1 = mysqli_query($con, $sqlpro1);
    ?>
    $whitelist = array();
    while ($row = mysqli_fetch_assoc($querypro1)) {
